...
object PhysxLoader {
    ...
    /**
     * リソースからライブラリをコピーします。
     * 展開先は `${java.io.tmpdir}/com.kamesuta.physx-jni/${physxJniVersion}` になります。
     */
    private fun copyLibsFromResources(forceCopy: Boolean): File {
        val tempLibDir =
            File(System.getProperty("java.io.tmpdir"), "com.kamesuta.physx-jni${File.separator}${physxJniVersion}")
        ...
        val libTmpFile = File(tempLibDir, "libs.jar")
